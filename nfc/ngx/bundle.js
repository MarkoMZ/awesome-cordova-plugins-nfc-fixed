...
var NFC = /** @class */ (function (_super) {
    ...
    NFC.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NFC, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    NFC.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NFC });
    NFC.pluginName = "NFC";
    NFC.plugin = "phonegap-nfc-fixed";
    NFC.pluginRef = "nfc";
    NFC.repo = "https://github.com/MarkoMZ/phonegap-nfc-fix.git";
    NFC.platforms = ["Android", "iOS", "Windows"];
    NFC = tslib.__decorate([], NFC);
    return NFC;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NFC, decorators: [{
            type: i0.Injectable
...
var Ndef = /** @class */ (function (_super) {
    ...
    Ndef.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: Ndef, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    Ndef.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: Ndef });
    Ndef.pluginName = "NFC";
    Ndef.plugin = "phonegap-nfc-fixed";
    Ndef.pluginRef = "ndef";
    Ndef = tslib.__decorate([], Ndef);
    return Ndef;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: Ndef, decorators: [{
            type: i0.Injectable
...
var NfcUtil = /** @class */ (function (_super) {
    ...
    NfcUtil.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NfcUtil, deps: null, target: i0__namespace.ɵɵFactoryTarget.Injectable });
    NfcUtil.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NfcUtil });
    NfcUtil.pluginName = "NFC";
    NfcUtil.plugin = "phonegap-nfc-fixed";
    NfcUtil.pluginRef = "util";
    NfcUtil = tslib.__decorate([], NfcUtil);
    return NfcUtil;
}(core.AwesomeCordovaNativePlugin));
i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NfcUtil, decorators: [{
            type: i0.Injectable
