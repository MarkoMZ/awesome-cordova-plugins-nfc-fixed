 ...
 */
export declare class NFC extends AwesomeCordovaNativePlugin {
 ...
 * @hidden
 */
export declare class Ndef extends AwesomeCordovaNativePlugin {
    TNF_EMPTY: number;
 ...
 * @hidden
 */
export declare class NfcUtil extends AwesomeCordovaNativePlugin {
