 ...
 */
export declare class NFCOriginal extends AwesomeCordovaNativePlugin {
 ...
 * @hidden
 */
export declare class NdefOriginal extends AwesomeCordovaNativePlugin {
    TNF_EMPTY: number;
 ...
 * @hidden
 */
export declare class NfcUtilOriginal extends AwesomeCordovaNativePlugin {
...
export declare class TextHelper extends AwesomeCordovaNativePlugin {
    decodePayload(data: number[]): string;
    encodePayload(text: string, lang: string): number[];
}
export declare class UriHelper extends AwesomeCordovaNativePlugin {
    decodePayload(data: number[]): string;
